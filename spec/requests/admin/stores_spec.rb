...
RSpec.describe "/admin/stores", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Admin::Store.create! valid_attributes
      get stores_url
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created store" do
        post stores_url, params: { store: valid_attributes }
        expect(response).to redirect_to(store_url(Admin::Store.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Admin::Store" do
        expect {
          post stores_url, params: { store: invalid_attributes }
        }.to change(Admin::Store, :count).by(0)
      end
